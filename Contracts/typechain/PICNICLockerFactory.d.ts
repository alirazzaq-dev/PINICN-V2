...
interface PICNICLockerFactoryInterface extends ethers.utils.Interface {
  functions: {
    "addTokenstoALocker(uint256,uint256)": FunctionFragment;
    "createLcoker(uint8,address,uint256,uint256)": FunctionFragment;
...
export class PICNICLockerFactory extends BaseContract {
  ...
  interface: PICNICLockerFactoryInterface;
