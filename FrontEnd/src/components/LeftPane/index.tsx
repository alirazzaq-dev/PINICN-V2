...
export const LeftPaneContent = () => {
    ...
    const tabStyle = (url: string) => {
        return {
            ...
            background:
                window.location.pathname === url ? "#53C48A" : "#ffffff",
        };
    };
    ...
    return (
        <PaneContainer>
            <MainHeadingContainer>
                ...
                <MainHeadingText>Products</MainHeadingText>
            </MainHeadingContainer>

            <ProductDetailContainer>
                <ProductHeading>
                    {" "}
                    <Icon /> PICNIC LaunchPad{" "}
                </ProductHeading>
...
const LeftPane = () => {
    return <LeftPaneContainer>{LeftPaneContent()}</LeftPaneContainer>;
};
