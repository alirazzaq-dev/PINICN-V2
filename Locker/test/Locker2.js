var PICNICLockerFactory = artifacts.require("PICNICLockerFactory.sol");
...
contract("LockerFactory", (accounts) => {
  ...
  beforeEach(async () => {
    lockerFactory = await PICNICLockerFactory.new();
    lockerFactoryAddress = await lockerFactory.address;
  ...
  describe("Deployment =>", () => {
      ...
      it("deploys successfully", async () => {
        ...
        assert.notEqual(lockerFactoryAddress, 0x0);
        assert.notEqual(lockerFactoryAddress, "");
