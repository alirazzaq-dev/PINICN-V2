...
const ButtonComp = ({ text }: { text: string }) => {
    return (
        <Button variant='contained'
            sx={{
                border: 0, fontSize: "8px", borderRadius: 0, bgcolor: "#53C48A",
                '&:hover': {
                    bgcolor: "#53C48A",
                    color: "#fff"
                }
            ...
            <div className={classes.lockerBody1}>
                ...
                <div className={classes.lockertitleSectoin1}>
                    ...
                    <div className={classes.lockertitleText}>
                        ...
                        <div style={{ border: "0px solid black", fontWeight: "bold" }}>
                        ...
                        <div style={{ border: "0px solid black", }}>
                            ...
                            <FormControlLabel onChange={handleOwnerView} control={<Switch defaultChecked />} label="Owner View" />
                    ...
                    <div style={{ border: "0px solid black" }} >
                        ...
                        <div className={classes.infoElement} >
                            <div style={{ color: "#363636" }}> Total Amount Locked </div>
                            <div style={{ color: "#7D7D7D" }} > 2 000.00 $PIC </div>
                        </div>

                        <div className={classes.infoElement} >
                            <div style={{ color: "#363636" }}> Total Values Locked </div>
                            <div style={{ color: "#7D7D7D" }} > $0 </div>
                        </div>

                        <div className={classes.infoElement} >
                            <div style={{ color: "#363636" }}> Lockup Date </div>
                            <div style={{ color: "#7D7D7D" }} > 25-11-2025 11 00 UTC</div>
                        </div>

                        <div className={classes.infoElement} >
                            <div style={{ color: "#363636" }}> Token Address </div>
                            <div style={{ color: "#1F88FE" }} > 0xECB972692dceFc51e9B45e096C7A0b1411019e9b </div>
                        </div>
                        ...
                        <div className={classes.infoElement} >
                            <div style={{ color: "#363636" }}> Token Symbol </div>
                            <div style={{ color: "#7D7D7D" }} > $PIC </div>
                        </div>

                        <div className={classes.infoElement} >
                            <div style={{ color: "#363636" }}> Token Decimals </div>
                ...
                isOwner && (
                    <div className={classes.lockerBody2}>
                        ...
                        <div className={classes.lockertitleSectoin2} >
                            <div className={classes.lockertitleSectoin2subContainer} >

                                <div className={classes.lockertitleSectoin2Title}> Withdraw </div>
                                <div className={classes.lockertitleSectoin2InputContainer}>
                                    <input type="number" defaultValue={0} className={classes.lockertitleSectoin2Input} />
                                </div>
                        ...
                        <div className={classes.lockertitleSectoin2} >
                            ...
                            <div className={classes.lockertitleSectoin2subContainer} >
                                ...
                                <div className={classes.lockertitleSectoin2Title}> Add Amount </div>
                                <div className={classes.lockertitleSectoin2InputContainer}>
                                    <input type="number" defaultValue={0} className={classes.lockertitleSectoin2Input} />
                                </div>
                                <div className={classes.lockertitleSectoin2Button}>
